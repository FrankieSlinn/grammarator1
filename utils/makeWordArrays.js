...
//   }
  insertHelpfulWords(numberOfRows, newWords, rowLength, fullWordArray, setFullWordArray);
}
...
export { insertActors, insertFinalWord, insertVerbs, makeWordArrays, randomNumberGenerator };
